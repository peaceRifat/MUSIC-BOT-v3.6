...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      const youtubeLink = 'https://www.youtube.com/watch?v=BT9h5ifR1tY';
      const InstagramLink = 'https://www.instagram.com/rifat_0.1/';
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'https://discord.gg/FUEHs7RCqz'
            ...
            .setDescription(`__**About me**__:\n\n ▶️ Im Ken. I like forex and binary trading \n YouTube : ❤️ [Ken](${youtubeLink})\n Instagram : 💙 [rifat_0.1](${InstagramLink})`)
            .setTimestamp();
